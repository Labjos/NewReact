...
import { faWhatsappSquare, faFacebookSquare, faInstagramSquare,  faYoutubeSquare} from '@fortawesome/free-brands-svg-icons'
import './footer.css'
    ...
    return (
        <div className = "footer">
            <div className="pie">
                ...
                <div id="iconoInstagram"><FontAwesomeIcon icon= { faInstagramSquare } /></div>
